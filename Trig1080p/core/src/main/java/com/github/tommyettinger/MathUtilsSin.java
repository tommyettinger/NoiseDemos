...
public class MathUtilsSin extends ApplicationAdapter {
    ...
    public void putMap() {
        ...
        for (int x = 0; x < width; x++) {
            ...
            for (int y = 0; y < height; y++, c += 0x1p-9f) {
                renderer.color(BitConversion.intBitsToFloat((BitConversion.floatToIntBits(MathUtils.sin(c)) & 0x00FFFFFF) | 0xFE000000));
